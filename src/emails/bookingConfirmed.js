...
export function bookingConfirmedHtml({ user, booking, vehicle, payment }) {
  ...
  const body = `
    ...
    <p style="margin:0 0 16px;">Your payment has been received successfully. Your booking is now <b>confirmed</b>.</p>
    ...
    <table style="width:100%;border-collapse:collapse;margin:16px 0;">
      ...
      <tr><td style="padding:8px 0;color:#334155;">Amount</td><td style="padding:8px 0;"><b>${fmtINR(booking?.price?.total)}</b></td></tr>
      <tr><td style="padding:8px 0;color:#334155;">Payment ID</td><td style="padding:8px 0;">${payment?.paymentId || "-"}</td></tr>
      <tr><td style="padding:8px 0;color:#334155;">From</td><td style="padding:8px 0;">${fmtDT(booking.start)}</td></tr>
      <tr><td style="padding:8px 0;color:#334155;">To</td><td style="padding:8px 0;">${fmtDT(booking.end)}</td></tr>
