      ...
      <tr><td align="center">
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:10px;overflow:hidden;font:14px/1.6 -apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#111;">
          <tr><td style="padding:20px 24px;border-bottom:1px solid #eef0f3">
            <div style="font-size:18px;font-weight:600;color:#111">VRUMA Cars</div>
          ...
          <tr><td style="padding:24px">
            ...
            <p style="margin:0 0 16px;">Click the button below to set a new password. This link expires in <strong>30 minutes</strong>.</p>
            ...
            <p style="margin:0 0 8px;color:#6b7280;font-size:12px;">If the button doesn’t work, copy this link:</p>
            <p style="word-break:break-all;margin:0 0 20px;color:#1f2937;font-size:12px;">${link}</p>
            <p style="margin:0;">Sincerely,<br/>The VRUMA Cars Team</p>
          </td></tr>
          <tr><td style="padding:16px 24px;border-top:1px solid #eef0f3;color:#6b7280;font-size:12px;">This is an automated message. Please do not reply.</td></tr>
        </table>
        <div style="color:#9ca3af;font-size:12px;margin-top:12px;">© ${new Date().getFullYear()} VRUMA Cars</div>
      </td></tr>
    </table>
  </body>
</html>`;
