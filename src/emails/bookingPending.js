// server/src/emails/bookingPending.js
...
export function bookingPendingHtml({ user, booking, vehicle }) {
  ...
  const body = `
    ...
    <p>Your booking has been created. Please complete the payment to confirm your vehicle.</p>
    ...
    <table style="width:100%;border-collapse:collapse;margin:16px 0;">
      ...
      <tr><td style="padding:6px 0;color:#334155;">From</td><td style="padding:6px 0;">${new Date(booking.start).toLocaleString()}</td></tr>
      <tr><td style="padding:6px 0;color:#334155;">To</td><td style="padding:6px 0;">${new Date(booking.end).toLocaleString()}</td></tr>
    </table>
